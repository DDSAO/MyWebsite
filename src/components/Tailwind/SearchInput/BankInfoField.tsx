import { BankInfo } from "@/interfaces/invoiceDefinition";
...
export const BankInfoField = (props: {
  onChangeF: (company: BankInfo | null) => void;
  value: BankInfo | null;
  title?: string;
  disableEdit?: boolean;
  type?: string;
          ...
          <ul className="rounded-md ">
            {options.map((option, i) => {
              return (
                ...
                >
                  <b className="text-md whitespace-nowrap">{option.name} </b>
